...
st.set_page_config(page_title='Extrator DIRF + Motor Previdenciário V1.2.32', page_icon='⚖️', layout='wide', initial_sidebar_state='expanded')
...
/* V1.2.32 — navegação principal e blocos auxiliares */
...
st.title('Extrator DIRF + Motor Previdenciário V1.2.32')
