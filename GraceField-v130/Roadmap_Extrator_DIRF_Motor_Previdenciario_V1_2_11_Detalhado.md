...
**Versão:** consolidação atualizada até a V1.2.11\
**Status:** documento-base atualizado --- descreve o estado do projeto
até a V1.2.11 e orienta as próximas etapas.
...
# 80-A. ATUALIZAÇÃO DA V1.2.11 --- ESTADO ATUAL DO PROJETO
...
## 80-A.3. V1.2.11 --- Escopo da Apuração
...
# Atualização V1.2.11 — recolhimento sem remuneração

A apuração deve considerar a **Previdência Oficial informada na DIRF mesmo quando a remuneração da fonte é R$ 0,00**.

Regra operacional:

```text
Remuneração = R$ 0,00
Previdência DIRF > R$ 0,00
        ↓
recolhimento preservado e somado
        ↓
não consome o teto pela remuneração
        ↓
não bloqueia a apuração por classificação pendente
```

Essa situação é tratada como recolhimento efetivo da fonte e deve permanecer visível na memória da competência. O grupo previdenciário continua relevante para fontes que possuam remuneração positiva.
